...
const hikeList = document.getElementById("search");
...
// const jumbledLetters = ["e", "l", "p", "a", "x"];
...
//     {name: "Mosiah", chapters: 1},
//     {name: "Alma", chapters: 63},
//     {name: "Helaman", chapters: 1},
...
//     return book.name.toLowerCase().includes('ephi'); 
