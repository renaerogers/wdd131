...
const recipeList = document.getElementById("search");

// function search() {

//     let recipeQuery = document.querySelector('#search-recipe').value;
...
// Update the listener to pass the event
